...
export function MenuIcon({ className }: IconProps) {
  return (
    <svg className={cn("h-6 w-6", className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function getServiceIcon(iconName: string, className?: string) {
  const icons: Record<string, React.ReactNode> = {
    ...
    monitor: <MonitorIcon className={className} />,
    globe: <GlobeIcon className={className} />,
  }
  return icons[iconName] || <CodeIcon className={className} />
}
...
export function getSocialIcon(platform: string, className?: string) {
  const icons: Record<string, React.ReactNode> = {
    ...
    dribbble: <DribbbleIcon className={className} />,
    mail: <MailIcon className={className} />,
    email: <MailIcon className={className} />,
    heart: <HeartIcon className={className} />,
  }
  return icons[platform.toLowerCase()] || <LinkIcon className={className} />
}
